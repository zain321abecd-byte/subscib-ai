...
export const metadata: Metadata = {
  ...
  description: "Save with pre-mixed AI subscription bundles — Creator, Growth, and Business tiers. All paid in PKR via JazzCash, Easypaisa, or Card. Cancel anytime.",
